    ...
    <div class="sidebar pb-4 mb-4">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php if($_SESSION['login_type'] == 1): ?>
            <li class="nav-item dropdown">
            <a href="./index.php?page=user_list" class="nav-link nav-usres">
        ...
        <?php endif; ?>
          ...
          <li class="nav-item dropdown">
            <a href="./index.php?page=complaints" class="nav-link nav-complaints">
           ...
           <li class="nav-item dropdown">
            <a href="./index.php?page=complaints_report" class="nav-link nav-reports">
              <i class="nav-icon fas fa-file"></i>
              <p>
               Complaint  Reports
              </p>
